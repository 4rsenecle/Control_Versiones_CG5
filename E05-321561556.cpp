...
int main()
{
	...
	Goddard_PDD = Model();
	Goddard_PDD.LoadModel("Models/goddard_patadelanteraderecha.obj");

	Goddard_PDT = Model();
	Goddard_PDT.LoadModel("Models/goddard_patatraseraderecha.obj");

	Goddard_PID = Model();
	Goddard_PID.LoadModel("Models/goddard_patadelanteraizquierda.obj");

	Goddard_PIT = Model();
	Goddard_PIT.LoadModel("Models/goddard_patatraseraizquierda.obj");
