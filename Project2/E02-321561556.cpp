...
void CrearLetrasyFiguras()
{
	...
	GLfloat vertices_triangulomedioverde[] = {
		//X			Y			Z			R		G		B
	...
	MeshColor* triangulomedioverde = new MeshColor();
	triangulomedioverde->CreateMeshColor(vertices_triangulomedioverde, 18);
	meshColorList.push_back(triangulomedioverde);
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.2f, -0.3f, -4.0f));
		...
		// Triángulo Medio Verde izquierdo

		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.72f, -0.6f, -4.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshColorList[3]->RenderMeshColor();

		// Triángulo Medio Verde derecho
		...
		// Cuadrado café izquierdo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.72f, -0.9f, -4.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshColorList[5]->RenderMeshColor();
